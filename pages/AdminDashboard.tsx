...
export const AdminDashboard: React.FC = () => {
  const [stats, setStats] = useState({ totalLeads: 0, activeProjects: 0, completedIntakes: 0, abandonedCarts: 0 });
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center">
            ...
            <div>
              <p className="text-sm font-medium text-slate-500">Carrinhos Abandonados</p>
              <h3 className="text-3xl font-bold text-slate-900">{stats.abandonedCarts}</h3>
            </div>
          </div>
        </div>
      )}
